    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: CalendarClock,
          items: [
            { title: "Current Roster", url: "/roster" },
            { title: "Today", url: "/roster/today" },
            { title: "My Roster", url: "/roster/my-roster" },
            { title: "Planner", url: "/roster/planner" },
            { title: "Swap Requests", url: "/roster/swaps" },
            { title: "Monthly Calendar", url: "/roster/calendar" },
            { title: "Maintenance", url: "/roster/maintenance" },
          ],
        },
        {
          title: "Temp Changes",
